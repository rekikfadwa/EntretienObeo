 ...
 * </p>
 * <ul>
 *   <li>{@link dart.impl.FunctionImpl#getName <em>Name</em>}</li>
 *   <li>{@link dart.impl.FunctionImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link dart.impl.FunctionImpl#getType <em>Type</em>}</li>
 *   <li>{@link dart.impl.FunctionImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link dart.impl.FunctionImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link dart.impl.FunctionImpl#getBody <em>Body</em>}</li>
 *   <li>{@link dart.impl.FunctionImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link dart.impl.FunctionImpl#getMetadata <em>Metadata</em>}</li>
 * </ul>
 *
 * @generated
 */
