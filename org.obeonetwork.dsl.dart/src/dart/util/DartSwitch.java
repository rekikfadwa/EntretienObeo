...
public class DartSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case DartPackage.PACKAGE: {
				dart.Package package_ = (dart.Package)theEObject;
			...
			case DartPackage.CLASS: {
				dart.Class class_ = (dart.Class)theEObject;
	 ...
	 * @generated
	 */
	public T casePackage(dart.Package object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(dart.Class object) {
		return null;
	}
